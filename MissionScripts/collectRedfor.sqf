...
redfor_vehicle_level_0_deploymentData = [];
...
_lvl0Veh = missionNamespace getVariable ["redfor_vehicle_level_0",objNull];
redfor_vehicle_level_0_deploymentData = [_lvl0Veh] call fnc_collect_vehicle;
deleteVehicle _lvl0Veh;
