...
if (_slider1 isEqualType controlNull) then { _slider1 = ctrlIDC _slider1 };
if (_text1 isEqualType controlNull) then { _text1 = ctrlIDC _text1 };
if (_slider2 isEqualType controlNull) then { _slider2 = ctrlIDC _slider2 };
if (_text2 isEqualType controlNull) then { _text2 = ctrlIDC _text2 };
