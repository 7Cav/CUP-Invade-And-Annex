...
_secondaryUnderbarrelMagazines = [];
_handgunMagazines = [
...
_secondaryRails = [] + _primaryRails;
_handgunRails = [
	"cup_acc_cz_m3x",
	"cup_acc_glock17_flashlight",
	"cup_acc_mlpls_laser",
	"cup_acc_mlpls_laser"] + _primaryRails;
_primaryOptics = [
...
_secondaryOptics = ["cup_optic_maaws_scope"] + _primaryOptics;
_handgunOptics = [] + _primaryOptics;
_primaryBipods = [
